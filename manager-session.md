...
10. Reminders: football gets one shot reminders about 90 minutes before each kickoff window that touches a rostered player this week, a Tuesday morning waiver check, and a recurring hourly league watch (rules/standing-league-watch.md). Basketball and baseball get a morning lineup pass and a pass an hour before the first game every day plus the hourly watch (rules/daily-sports.md). They are session only; recreate them after any restart. Tell me they expire in seven days.
